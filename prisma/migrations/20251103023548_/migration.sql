...
-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `products_artistId_fkey` FOREIGN KEY (`artistId`) REFERENCES `artists`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
